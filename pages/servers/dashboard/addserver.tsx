    ...
    <div className={styles.container} style={{marginTop: "5rem"}}>
      ...
      <div className="flex flex-col justify-center items-center flex-wrap min-h-[50vh]">
          ...
          {server ? (<>
            ...
            <button onClick={() => (submitServer())} className='focus:outline-none hover:ring-sky-500 hover:border-sky-500 hover:ring-1 hover:ring-sky-500 border rounded-2xl w-full lg:w-[55vw] max-w-[95vw] h-16 text-2xl font-bold mb-8'>신청하기</button>
          </>) : (<>
